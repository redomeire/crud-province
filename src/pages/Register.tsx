                ...
                <div className="md:w-[50%] bg-white p-10 md:rounded-tl-lg md:rounded-bl-lg md:rounded-b-none rounded-b-lg">
                    ...
                    <form onSubmit={handleSubmit} className="mt-10">
                        ...
                        <div className="flex items-center mt-5 md:flex-row flex-col">
                            <Button className="bg-purple-500 text-white text-sm md:w-fit w-full">Submit</Button>
                            <p className="ml-5 md:mt-0 mt-3">Sudah punya akun? <span className="font-semibold text-purple-300 cursor-pointer" onClick={() => navigate('/login')}>Login</span></p>
                        </div>
                    </form>
                </div>
